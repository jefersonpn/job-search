<template>
  <header class="w-full text-sm">
    <div class="fixed left-0 top-0 h-16 w-full bg-white">
      <div class="mx-auto flex h-full flex-nowrap border-b border-solid border-x-brand-gray-1 px-8">
...
export default {
  ...
  data() {
    return {
      ...
      menuItems: ['Teams', 'Locations', 'Life at Dev Careers', 'How we hire', 'Students', 'Jobs']
    }
  }
}
</script>
